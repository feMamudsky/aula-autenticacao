...
class AuthRequests {
     ...
     */
/**
 * Remove o token e as informações do usuário no localStorage
 */
removeToken() {
    // Remove todas as chaves do localStorage relacionadas ao login
    localStorage.removeItem('token');
    localStorage.removeItem('username');
    localStorage.removeItem('idUsuario'); // Certifique-se de que esta chave está sendo removida
    localStorage.removeItem('Chave'); // Se houver uma chave adicional, remova aqui
